...
$query = $dbh->prepare($sql);
$query->bindValue(':status', 1, PDO::PARAM_INT); // Assuming you want to fetch bookings with status = 0
$query->execute();
$results = $query->fetchAll(PDO::FETCH_OBJ);
...
<head>
	...
	<title>Backpackers | Confirmed Bookings   </title>
								...
								<table class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									...
									<?php 
										...
										<td><?php echo htmlentities($cnt);?></td>
											...
											<td <?php if($result->status == 0) { ?> style="color: #007bff;" <?php } elseif ($result->status == 1) { ?> style="color: #28a745;" <?php } else { ?> style="color: #dc3545;" <?php } ?>>
    <?php 
    if($result->status == 0) {
