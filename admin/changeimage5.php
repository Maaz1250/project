...
<head>
	...
	<title>Backpackers | Update Image 5</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">Hotel Image 5 </h2>

						<div class="row">
							<div class="col-md-10">
								<div class="panel panel-default">
									<div class="panel-heading">Hotel Image 5 Details</div>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT Himage5 from hotels where hotels.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
