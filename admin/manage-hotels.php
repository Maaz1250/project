...
if(strlen($_SESSION['alogin'])==0) {    
    ...
    if(isset($_REQUEST['del'])) {
        ...
        $sql = "delete from hotels  WHERE  id=:delid";
    ...
    if(isset($_POST['search'])) {
        $search = $_POST['search'];
        $sql = "SELECT hotels.HotelName, states.StateName, hotels.PricePerNight, hotels.id 
                FROM hotels 
...
<head>
    ...
    <title>Backpackers | Manage Hotels</title>
                                            ...
                                            if($query->rowCount() > 0) {
                                                foreach($results as $result) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="edit-hotels.php?id=<?php echo $result->id;?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
                                                            <a href="manage-hotels.php?del=<?php echo $result->id;?>" onclick="return confirm('Do you want to delete');"><i class="fa fa-close"></i></a>
                                                        </td>
                                                    </tr>
                                                    <?php $cnt=$cnt+1; 
                                        } ?>
