...
$sql="update rooms set rimage=:rimage where id=:id";
...
<head>
	...
	<title>Backpackers | Update Room Image</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT rimage from rooms where rooms.id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-8">
<img src="img/roomimages/<?php echo htmlentities($result->rimage);?>" width="300" height="200" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
